...
class Concert: NSObject, MKAnnotation {
    ...
    var dictionary : [String: Any] {
        ...
        return ["artist": artist, "date": timeIntervalDate, "ticketPrice": ticketPrice, "ticketLink": ticketLink, "latitude": latitude, "longitude": longitude, "postingUserID": postingUserID, "documentID": documentID]
    }
    
    init(artist: String, date: Date, ticketPrice: String, ticketLink: String, coordinate: CLLocationCoordinate2D, postingUserID: String, documentID: String) {
    ...
    convenience init(dictionary: [String: Any]) {
        ...
        self.init(artist: artist, date: date, ticketPrice: ticketPrice, ticketLink: ticketLink, coordinate: coordinate, postingUserID: postingUserID, documentID: "")
    }
    ...
    convenience override init() {   // before having the map, we had just convenience init(), accept fix suggested to add override here
        self.init(artist: "", date: Date(), ticketPrice: "",  ticketLink: "", coordinate: CLLocationCoordinate2D(), postingUserID: "", documentID: "")
    }
